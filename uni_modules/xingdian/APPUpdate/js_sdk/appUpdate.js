...
// 主颜色
const $mainColor = appUpdateConfig.appUpdateColor ? appUpdateConfig.appUpdateColor : "FF5B78";
// 弹窗图标url
const $iconUrl = appUpdateConfig.appUpdateIcon ? appUpdateConfig.appUpdateIcon : "/static/images/ic_ar.png";
...
export default function(isPrompt = false) {
	getCurrentNo(versionInfo => {
		appUpdateConfig.getServerNo(versionInfo, isPrompt, res => {
