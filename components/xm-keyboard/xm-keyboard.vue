<template>
	<view class="xm-keyboard" v-cloak>
			...
			<view class="xm-box" :class="anim?'xm-animation':''">
				<view class="xm-toolbar">
					...
					<view class="xm-toolbar-right">
						<template v-show="exchange">
							<view class="xm-toolbar-item" v-for="(item, index) in typeList" :key="index" @tap="changeType(item, index)">
								{{ item.name }}
							</view>
						</template>
				...
				<view class="xm-main" :class="['xm-mode-' + typeInfo.mode, ]">
