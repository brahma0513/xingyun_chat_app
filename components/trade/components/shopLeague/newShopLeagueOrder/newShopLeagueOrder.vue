		...
		<view class="custom-order" style="padding: 0;">
			<view class="type2" v-if="datas.content.select_style==2"
				...
				<view class="order-title" :style="'background-image:url('+http_host+'/shop_league/web/static/images/icon_right.png)'">
					<view @click="goUrl" :data-hurl="'/shop_league/web/index.php?m=store&a=order_center'" data-url="/shop_league/pages/store/order_center/order_center">
						<view class="img">
			...
			<view class="type1" v-if="datas.content.select_style==1"
				...
				<view @click="goUrl" :data-hurl="'/shop_league/web/index.php?m=store&a=order_center'" data-url="/shop_league/pages/store/order_center/order_center">
					<view class="title">
						...
						<p class="more"
							:style="'background-image:url('+http_host+'/shop_league/web/static/images/icon_right.png)'">
							全部订单</p>
					</view>
				</view>
				<ul class="order-list">
					<li>
						<view @click="goUrl" :data-hurl="'/shop_league/web/index.php?m=store&a=order_center&type=wait_pay'" data-url="/shop_league/pages/store/order_center/order_center"
					...
					<li>
						<view @click="goUrl" :data-hurl="'/shop_league/web/index.php?m=store&a=order_center&type=wait_receive'" data-url="/shop_league/pages/store/order_center/order_center"
					...
					<li>
						<view @click="goUrl" :data-hurl="'/shop_league/web/index.php?m=store&a=order_center&type=wait_use&personal_center_tab_topIndex=2'" data-url="/shop_league/pages/store/order_center/order_center"
					...
					<li>
						<view @click="goUrl" :data-hurl="'/shop_league/web/index.php?m=store&a=order_center&type=wait_finish'" data-url="/shop_league/pages/store/order_center/order_center"
					...
					<li>
						<view @click="goUrl" :data-hurl="'/shop_league/web/index.php?m=store&a=order_center&type=finished'" data-url="/shop_league/pages/store/order_center/order_center"
